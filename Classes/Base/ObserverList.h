...
#define FOR_EACH_OBSERVER_RETURN(ObserverType, observer_list, func)     \
  do {                                                                \
...
#define FOR_EACH_OBSERVER_LRESULT(ObserverType, observer_list, func)    \
  do {                                                                  \
  ObserverListBase<ObserverType>::Iterator it(observer_list);         \
  ObserverType* obs;                                                  \
  while ((obs = it.GetNext()) != NULL)                                \
  if (HTTRANSPARENT == obs->func)                                    \
